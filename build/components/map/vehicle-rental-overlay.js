...
var VehicleRentalOverlay = (_temp = _class = function (_Component) {
  (0, _inherits3.default)(VehicleRentalOverlay, _Component);

  function VehicleRentalOverlay() {
    (0, _classCallCheck3.default)(this, VehicleRentalOverlay);
    return (0, _possibleConstructorReturn3.default)(this, (VehicleRentalOverlay.__proto__ || (0, _getPrototypeOf2.default)(VehicleRentalOverlay)).apply(this, arguments));
  }

  (0, _createClass3.default)(VehicleRentalOverlay, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        filteredStations.map(function (station) {
          ...
          var className = 'fa fa-map-marker vehicle-rental-icon';
...
var mapDispatchToProps = {
  refreshVehicles: _api.vehicleRentalQuery,
  setLocation: _map.setLocation
};

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(VehicleRentalOverlay);
