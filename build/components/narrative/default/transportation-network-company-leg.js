...
var TransportationNetworkCompanyLeg = function (_Component) {
  ...
  (0, _createClass3.default)(TransportationNetworkCompanyLeg, [{
    ...
    key: '_resolveTncData',
    value: function _resolveTncData(props) {
      var _props = this.props,
          companies = _props.companies,
          getTransportationNetworkCompanyEtaEstimate = _props.getTransportationNetworkCompanyEtaEstimate,
          getTransportationNetworkCompanyRideEstimate = _props.getTransportationNetworkCompanyRideEstimate,
          leg = _props.leg,
          tncData = _props.tncData;
      ...
      var hasTncEtaData = tncData.etaEstimates[from] && tncData.etaEstimates[from][companies] && tncData.etaEstimates[from][companies][rideType] && tncData.etaEstimates[from][companies][rideType].estimateTimestamp.getTime() + 30000 > now;
      ...
      var hasTncRideData = tncData.rideEstimates[from] && tncData.rideEstimates[from][to] && tncData.rideEstimates[from][to][companies] && tncData.rideEstimates[from][to][companies][rideType] && tncData.rideEstimates[from][to][companies][rideType].estimateTimestamp.getTime() + 30000 > now;
    ...
    value: function render() {
      var legMode = this.props.legMode;
      ...
      return _react2.default.createElement(
        ...
        rideEstimate && _react2.default.createElement(
          ...
          (0, _time.formatDuration)(rideEstimate.duration)
        ),
        rideEstimate && _react2.default.createElement(
          'p',
          null,
...
TransportationNetworkCompanyLeg.propTypes = {
...
//# sourceMappingURL=transportation-network-company-leg.js