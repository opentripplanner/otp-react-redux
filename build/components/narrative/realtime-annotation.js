  ...
  _createClass(RealtimeAnnotation, [{
    ...
    value: function render() {
      ...
      var innerContent = _react.default.createElement("div", {
        ...
        className: "small"
      }, "Your trip results have been adjusted based on real-time information. Under normal conditions, this trip would take", ' ', _react.default.createElement("b", null, _coreUtils.default.time.formatDuration(realtimeEffects.normalDuration), " "), "using the following routes:", ' ', filteredRoutes.map(function (route, idx) {
