...
var ConnectedTransitLegSubheader =
/*#__PURE__*/
function (_Component) {
  _inherits(ConnectedTransitLegSubheader, _Component);

  function ConnectedTransitLegSubheader() {
    var _getPrototypeOf2;

    var _this;

    _classCallCheck(this, ConnectedTransitLegSubheader);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(ConnectedTransitLegSubheader)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _defineProperty(_assertThisInitialized(_this), "onClick", function (payload) {
  ...
  _createClass(ConnectedTransitLegSubheader, [{
    key: "render",
    value: function render() {
      var _this$props2 = this.props,
          languageConfig = _this$props2.languageConfig,
          leg = _this$props2.leg;
      return _react.default.createElement(_transitLegSubheader.default, {
  ...
  return ConnectedTransitLegSubheader;
}(_react.Component);
