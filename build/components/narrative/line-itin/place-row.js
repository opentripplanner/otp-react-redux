  ...
  _createClass(RentedVehicleLeg, [{
    ...
    value: function render() {
      ...
      if (leg.rentedBike) {
        ...
        var modeString = leg.rentedVehicle ? 'eScooter' : leg.rentedBike ? 'bike' : 'car'; // The networks attribute of the from data will only appear at the very
        ...
        if (leg.from.networks) {
          ...
          rentalDescription += " ".concat(companiesLabel); // Only show vehicle name for car rentals. For bikes and eScooters, these
