    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        return _react.default.createElement(_reactBootstrap.Button, {
          ...
          className: "details"
        }, formatDuration(itinerary.duration), _react.default.createElement("span", null, _react.default.createElement("br", null), formatTime(itinerary.startTime, timeOptions), " - ", formatTime(itinerary.endTime, timeOptions)), _react.default.createElement("span", null, _react.default.createElement("br", null), minTotalFare ? _react.default.createElement("span", null, "".concat(centsToString(minTotalFare)).concat(plus), " \u2022 ") : '', Math.round(caloriesBurned), " Cal"), itinerary.transfers > 0 && _react.default.createElement("span", null, _react.default.createElement("br", null), itinerary.transfers, " transfer", itinerary.transfers > 1 ? 's' : '')));
