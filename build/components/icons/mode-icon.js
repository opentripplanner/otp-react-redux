  ...
  (0, _createClass3.default)(ModeIcon, [{
    ...
    value: function render() {
      switch (this.props.mode.toLowerCase()) {
        case 'bus':
          return _react2.default.createElement(BusIcon, null);
        case 'tram':
        case 'rail':
        case 'subway':
          return _react2.default.createElement(TramIcon, null);
        case 'walk':
          return _react2.default.createElement(WalkIcon, null);
        case 'bicycle':
        case 'bicycle_rent':
          return _react2.default.createElement(BicycleIcon, null);
        case 'ferry':
          return _react2.default.createElement(FerryIcon, null);
        case 'gondola':
...
var TramIcon = function (_Component3) {
  (0, _inherits3.default)(TramIcon, _Component3);
  ...
  (0, _createClass3.default)(TramIcon, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'svg',
        { xmlns: 'http://www.w3.org/2000/svg', version: '1.0', viewBox: '0 0 66.461 100', height: '100%', width: '100%' },
        _react2.default.createElement('path', { d: 'M28.549,7.023c-1.933-0.007-3.508-1.582-3.512-3.511C25.041,1.555,26.616-0.021,28.549,0  c1.952-0.021,3.526,1.555,3.511,3.512C32.075,5.441,30.5,7.016,28.549,7.023L28.549,7.023z' }),
        _react2.default.createElement('path', { d: 'M37.913,7.023c1.936-0.007,3.512-1.582,3.512-3.511c0-1.957-1.576-3.532-3.512-3.512c-1.95-0.021-3.525,1.555-3.512,3.512  C34.388,5.441,35.963,7.016,37.913,7.023L37.913,7.023z' }),
        _react2.default.createElement('path', { d: 'M51.856,78.064c4.872-0.809,9.73-5.898,9.719-12.109V20.611C61.587,14.218,56.2,8.34,48.903,8.347H33.281H17.606  C10.265,8.34,4.878,14.218,4.885,20.611v45.344c-0.007,6.211,4.852,11.301,9.719,12.109L0,100h8.446l10.432-15.37H33.23h14.351  L58.063,100h8.397L51.856,78.064z M24.986,13.031c0.002-1.136,0.969-2.072,2.085-2.088h6.158h6.159  c1.117,0.016,2.088,0.952,2.088,2.088v3.559c0,1.133-0.916,2.092-2.088,2.088H33.23h-6.158c-1.167,0.004-2.083-0.955-2.085-2.088  V13.031z M17.301,71.45c-3.059-0.023-5.553-2.517-5.546-5.598c-0.007-3.071,2.487-5.562,5.546-5.547  c3.09-0.016,5.584,2.476,5.598,5.547C22.886,68.934,20.391,71.427,17.301,71.45z M18.014,41.986  c-3.508-0.021-6.369-2.421-6.362-6.363v-8.141c0.025-3.396,2.219-6.356,6.362-6.363H33.23h15.215  c4.148,0.007,6.343,2.967,6.363,6.363v8.141c0.011,3.942-2.85,6.343-6.363,6.363H33.23H18.014z M43.46,65.853  c-0.009-3.071,2.482-5.562,5.545-5.547c3.09-0.016,5.584,2.476,5.6,5.547c-0.016,3.081-2.51,5.574-5.6,5.598  C45.942,71.427,43.451,68.934,43.46,65.853z' })
      );
    }
  }]);
  return TramIcon;
...
var WalkIcon = function (_Component4) {
  (0, _inherits3.default)(WalkIcon, _Component4);

  function WalkIcon() {
    (0, _classCallCheck3.default)(this, WalkIcon);
    return (0, _possibleConstructorReturn3.default)(this, (WalkIcon.__proto__ || (0, _getPrototypeOf2.default)(WalkIcon)).apply(this, arguments));
  }

  (0, _createClass3.default)(WalkIcon, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        'svg',
        { xmlns: 'http://www.w3.org/2000/svg', version: '1.0', x: '0px', y: '0px', viewBox: '0 0 55.74 100', height: '100%', width: '100%' },
        _react2.default.createElement('path', { d: 'M31.269,13.769c3.862,0,6.884-3.025,6.884-6.885C38.153,3.022,35.131,0,31.269,0c-3.86,0-6.885,3.022-6.885,6.884  C24.384,10.744,27.409,13.769,31.269,13.769z' }),
        _react2.default.createElement('path', { d: 'M1.249,51.724l4.512-0.421L5.863,35.25l8.224-5.204c0,0-1.333,10.545-1.333,16.085c0,4.831-0.172,8.736-0.172,8.736  L2.054,96.918L9.489,100L21.28,61.549l8.195,10.424l9.339,26.337l8.394-3.355l-9.425-27.965L27.446,50.665l2.901-21.399l6.46,13.544  l16.622,5.708l2.311-4.199l-15.234-8.887c0,0-3.691-9.819-6.711-15.962c-1.027-2.091-5.196-2.774-6.894-2.901  c-4.896-0.362-7.428,1.296-11.488,3.432C11.358,22.131,0,30.728,0,30.728L1.249,51.724z' })
      );
    }
  }]);
  return WalkIcon;
...
var GondolaIcon = function (_Component7) {
  (0, _inherits3.default)(GondolaIcon, _Component7);

  function GondolaIcon() {
    (0, _classCallCheck3.default)(this, GondolaIcon);
    return (0, _possibleConstructorReturn3.default)(this, (GondolaIcon.__proto__ || (0, _getPrototypeOf2.default)(GondolaIcon)).apply(this, arguments));
  }

  (0, _createClass3.default)(GondolaIcon, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        'svg',
        { xmlns: 'http://www.w3.org/2000/svg', version: '1.0', viewBox: '0 0 100 89.383', height: '100%', width: '100%' },
        _react2.default.createElement('polygon', { points: '100,3.417 100,0 0,38.239 0,41.663 ' }),
        _react2.default.createElement('path', { d: 'M43.871,16.965c2.986,0,5.425-2.467,5.425-5.507c0-3.034-2.439-5.476-5.425-5.476c-3.009,0-5.448,2.442-5.448,5.476  C38.424,14.498,40.864,16.965,43.871,16.965z' }),
        _react2.default.createElement('path', { d: 'M77.553,45.469H53.319V25.603l-3.385,1.364v18.502H25.477c-1.915,0-3.477,1.576-3.477,3.516V85.86  c0,1.939,1.562,3.523,3.477,3.523h52.077c1.916,0,3.484-1.584,3.484-3.523V48.984C81.038,47.045,79.469,45.469,77.553,45.469z   M40.583,65.495c0,1.052-0.832,1.916-1.871,1.916H27.249c-1.038,0-1.891-0.864-1.891-1.916V53.94c0-1.051,0.854-1.915,1.891-1.915  h11.462c1.038,0,1.871,0.864,1.871,1.915V65.495z M59.211,65.351c0,1.057-0.848,1.892-1.893,1.892H45.887  c-1.047,0-1.893-0.835-1.893-1.892v-11.58c0-1.049,0.846-1.884,1.893-1.884h11.432c1.045,0,1.893,0.835,1.893,1.884V65.351z   M77.696,65.351c0,1.057-0.825,1.892-1.872,1.892H64.371c-1.038,0-1.893-0.835-1.893-1.892v-11.58c0-1.049,0.854-1.884,1.893-1.884  h11.453c1.047,0,1.872,0.835,1.872,1.884V65.351z' }),
        _react2.default.createElement('path', { d: 'M56.848,12.063c3,0,5.439-2.467,5.439-5.507s-2.439-5.507-5.439-5.507c-2.985,0-5.424,2.467-5.424,5.507  S53.863,12.063,56.848,12.063z' })
      );
    }
  }]);
  return GondolaIcon;
...
var CarIcon = function (_Component8) {
  (0, _inherits3.default)(CarIcon, _Component8);

  function CarIcon() {
    (0, _classCallCheck3.default)(this, CarIcon);
    return (0, _possibleConstructorReturn3.default)(this, (CarIcon.__proto__ || (0, _getPrototypeOf2.default)(CarIcon)).apply(this, arguments));
  }

  (0, _createClass3.default)(CarIcon, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        'svg',
        { xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 512 512', height: '100%', width: '100%' },
        _react2.default.createElement('path', { d: 'M499.991 168h-54.815l-7.854-20.944c-9.192-24.513-25.425-45.351-46.942-60.263S343.651 64 317.472 64H194.528c-26.18 0-51.391 7.882-72.908 22.793-21.518 14.912-37.75 35.75-46.942 60.263L66.824 168H12.009c-8.191 0-13.974 8.024-11.384 15.795l8 24A12 12 0 0 0 20.009 216h28.815l-.052.14C29.222 227.093 16 247.997 16 272v48c0 16.225 6.049 31.029 16 42.309V424c0 13.255 10.745 24 24 24h48c13.255 0 24-10.745 24-24v-40h256v40c0 13.255 10.745 24 24 24h48c13.255 0 24-10.745 24-24v-61.691c9.951-11.281 16-26.085 16-42.309v-48c0-24.003-13.222-44.907-32.772-55.86l-.052-.14h28.815a12 12 0 0 0 11.384-8.205l8-24c2.59-7.771-3.193-15.795-11.384-15.795zm-365.388 1.528C143.918 144.689 168 128 194.528 128h122.944c26.528 0 50.61 16.689 59.925 41.528L391.824 208H120.176l14.427-38.472zM88 328c-17.673 0-32-14.327-32-32 0-17.673 14.327-32 32-32s48 30.327 48 48-30.327 16-48 16zm336 0c-17.673 0-48 1.673-48-16 0-17.673 30.327-48 48-48s32 14.327 32 32c0 17.673-14.327 32-32 32z' })
      );
    }
  }]);
  return CarIcon;
