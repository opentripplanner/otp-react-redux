  ...
  _createClass(StopViewer, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        type: "refresh"
      }), ' ', (0, _moment.default)(stopData.stopTimesLastUpdated).tz(getUserTimezone()).format(timeFormat))), _react.default.createElement("b", null, "Plan a trip:"), _react.default.createElement(_fromToLocationPicker.default, {
        onFromClick: this._onClickPlanFrom,
        onToClick: this._onClickPlanTo
      })), stopData.stopTimes && stopData.routes && _react.default.createElement("div", {
        style: {
          marginTop: 20
        }
      }, Object.values(stopTimesByPattern).sort(function (a, b) {
        return _coreUtils.default.itinerary.routeComparator(a.route, b.route);
...
function getFormattedStopTime(stopTime, homeTimezone) {
  ...
  var formattedTime = formatSecondsAfterMidnight(stopTime.realtimeDeparture, // Only show timezone (e.g., PDT) if user is not in home time zone (e.g., user
