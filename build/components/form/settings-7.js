...
var SettingsSelectorPanel = (_temp = _class = function (_Component) {
  ...
  function SettingsSelectorPanel(props) {
    ...
    _this._setAccessMode = function (mode) {
      ...
      // Create object to contain multiple param updates if needed (e.g. mode, companies)
      var queryParamUpdate = {};

      // Retain all current transit modes
      queryModes = queryModes.filter(function (m) {
        return !(0, _itinerary.isAccessMode)(m);
      });

      // Add the selected access mode
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(_modeButton2.default, {
                active: modeHasTransit && this._modeIsActive('WALK'),
                icons: icons,
                mode: mode,
                height: 46,
                label: mode.label,
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    'div',
                    { style: { display: 'inline-block', marginRight: 5, width: 12, height: 12, verticalAlign: 'middle', fill: mode === 'WALK' ? '#fff' : '#000' } },
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    'div',
                    { style: { display: 'inline-block', marginRight: 5, width: 12, height: 12, verticalAlign: 'middle', fill: !modeHasTransit && (0, _itinerary.hasBike)(mode) ? '#fff' : '#000' } },
                ...
                _react2.default.createElement(
                  ...
                  bikeOptions.map(function (option, k) {
                    return _react2.default.createElement(
                      _reactBootstrap.Button,
                      { key: k,
                        style: { backgroundColor: queryModes.includes(option.mode) ? '#084c8d' : '#aaa', color: '#fff', letterSpacing: 1, textTransform: 'uppercase', fontSize: 12 },
...
//# sourceMappingURL=settings-7.js