        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement('div', { style: { position: 'absolute', bottom: 0, left: 0, right: 0, height: 1, backgroundColor: '#888', zIndex: 10 } }),
              _react2.default.createElement(
                'div',
                { style: { position: 'absolute', bottom: 0, left: 20, top: 0, width: 150, borderLeft: '1px solid #888', borderTop: '1px solid #888', borderRight: '1px solid #888', borderBottom: modeHasTransit ? 'none' : '1px solid #888', backgroundColor: '#f0f0f0', zIndex: 20 } },
                _react2.default.createElement(
                  'button',
                  {
                  ...
                  _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                      'div',
                      { style: { display: 'inline-block', marginRight: 10, width: 18, height: 18, verticalAlign: 'middle' } },
                      (0, _itinerary.getModeIcon)('TRANSIT', icons)
                    ),
                    _react2.default.createElement(
                      'div',
                      { style: { display: 'inline-block', fontSize: 18, fontWeight: 500, verticalAlign: 'middle' } },
                      'Take Transit'
                    )
                  )
                )
              ...
              _react2.default.createElement(
                'div',
                { style: { position: 'absolute', bottom: 0, right: 70, top: 0, width: 40, borderLeft: '1px solid #888', borderTop: '1px solid #888', borderRight: '1px solid #888', borderBottom: mode === 'WALK' ? 'none' : '1px solid #888', backgroundColor: '#f0f0f0', zIndex: 20 } },
                _react2.default.createElement(
                  'button',
                  {
                    style: tabButtonStyle,
                  ...
                  _react2.default.createElement(
                    ...
                    (0, _itinerary.getModeIcon)('WALK', icons)
                  ),
                  _react2.default.createElement(
                    'div',
              ...
              _react2.default.createElement(
                'div',
                { style: { position: 'absolute', bottom: 0, right: 20, top: 0, width: 40, borderLeft: '1px solid #888', borderTop: '1px solid #888', borderRight: '1px solid #888', borderBottom: !modeHasTransit && (0, _itinerary.hasBike)(mode) ? 'none' : '1px solid #888', backgroundColor: '#f0f0f0', zIndex: 20 } },
                _react2.default.createElement(
                  'button',
                  {
                    style: tabButtonStyle,
                  ...
                  _react2.default.createElement(
                    'div',
                    { style: { display: 'inline-block', width: 15, height: 15 } },
                    (0, _itinerary.getModeIcon)('BICYCLE', icons)
                  ),
                  _react2.default.createElement(
                    'div',
                    { style: { fontSize: 10, marginTop: -4 } },
...
//# sourceMappingURL=settings-5.js