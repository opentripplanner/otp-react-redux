...
var _lib = _interopRequireDefault(require("root/packages/location-icon/lib"));
...
function (_Component) {
  ...
  function LocationField(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "_geocodeAutocomplete", (0, _throttleDebounce.throttle)(1000, function (text) {
      ...
      (0, _geocoder.default)(_this.props.geocoderConfig).autocomplete({
        text: text
    ...
    _defineProperty(_assertThisInitialized(_this), "_onTextInputClick", function () {
      var _this$props = _this.props,
          ...
          geocoderConfig = _this$props.geocoderConfig,
    ...
    _defineProperty(_assertThisInitialized(_this), "_useCurrentLocation", function () {
      ...
      var location = (0, _map.currentPositionToLocation)(currentPosition);
  ...
  _createClass(LocationField, [{
    ...
    value: function _geocodeSearch(text) {
      ...
      (0, _geocoder.default)(this.props.geocoderConfig).search({
        text: text
      }).then(function (result) {
    ...
    value: function render() {
      ...
      var _this$props4 = this.props,
          ...
          geocoderConfig = _this$props4.geocoderConfig,
          ...
          userLocations = _this$props4.userLocations,
          userRecentPlaces = _this$props4.userRecentPlaces,
          nearbyStops = _this$props4.nearbyStops;
      var locations = [].concat(_toConsumableArray(userLocations), _toConsumableArray(userRecentPlaces));
      ...
      if (geocodedFeatures.length > 0) {
        ...
        menuItems = menuItems.concat(geocodedFeatures.map(function (feature, i) {
          ...
          var locationSelected = function locationSelected() {
            (0, _geocoder.default)(geocoderConfig).getLocationFromGeocodedFeature(feature).then(function (location) {
      ...
      if (locations.length > 0 && showUserSettings) {
        ...
        menuItems = menuItems.concat(locations.map(function (location, i) {
          ...
          var option = createOption(location.icon, (0, _map.formatStoredPlaceName)(location), locationSelected, itemIndex === activeIndex, i === locations.length - 1);
          itemIndex++;
          return option;
        }));
      }
      ...
      if (isStatic) {
        ...
        }, _react.default.createElement("form", null, _react.default.createElement(_reactBootstrap.FormGroup, null, _react.default.createElement(_reactBootstrap.InputGroup, null, _react.default.createElement(_reactBootstrap.InputGroup.Addon, null, _react.default.createElement(_lib.default, {
          type: type,
          width: 10
        ...
        return _react.default.createElement("form", null, _react.default.createElement(_reactBootstrap.FormGroup, {
          ...
          title: _react.default.createElement(_lib.default, {
            type: type
          }),
          noCaret: true
...
_defineProperty(LocationField, "defaultProps", {
  addLocationSearch: function addLocationSearch() {},
  ...
  findNearbyStops: function findNearbyStops() {},
  geocoderConfig: {
  ...
  location: null,
  nearbyStops: [],
  onLocationSelected: function onLocationSelected(payload) {
    return console.log('location selected', payload);
  },
  sessionSearches: [],
...
//# sourceMappingURL=location-field-2.js