...
// Remove extra margins around UserSettings.
// !important is needed otherwise the OTP CSS classes are applied.
...
class BatchRoutingPanel extends Component {
  ...
  render () {
    const {activeSearch, config, currentQuery, mobile, showUserSettings} = this.props
