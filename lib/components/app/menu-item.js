...
export class MenuItem extends Component {
  ...
  render () {
    ...
    // helper function when adding additional menu items from an array:
    ...
    //         >
    //           {extraSubMenuItems && (
    //             this._addExtraMenuItems(extraSubMenuItems)
    //           )}
    //         </MenuItem>
    //       )
    //     })
    ...
    return (
      <div className='menu-container'>
        <div className={`menu-item ${isSubmenuItem ? 'sub-menu-item' : ''}`}>
