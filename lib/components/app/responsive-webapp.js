...
import { handleBackButtonPress, matchContentToUrl, routeTo } from '../../actions/ui'
      ...
      <ConnectedRouter
        ...
        <div>
          <Switch>
            ...
            />
            <Route
              // This route is called by the auth0 redirect callback and is
              // used to determine what is ultimately shown after login.
              path={'/signedinswitch'}
              component={routerProps => {
                const props = this._combineProps(routerProps)
                return <AfterSignInSwitch {...props} />
              }}
            />
            <Route
              path='/print'
...
const mapDispatchToWrapperProps = {
  routeTo
}

export default withLoggedInUserSupport(
  connect(mapStateToWrapperProps, mapDispatchToWrapperProps)(RouterWrapper)
)
