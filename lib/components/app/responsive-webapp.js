...
import TimetableWrapper from '../viewers/timetable-wrapper'
  ...
  render() {
    ...
    const router = localizedMessages && (
      <ComponentContext.Provider value={components}>
        ...
        />
        {/* TimetableWrapper is present at this high a level so the portal can remain open even
        as the user navigates to other parts of the application */}
        {timetableEnabled && <TimetableWrapper />}
        <MapProvider>
          <IntlProvider
