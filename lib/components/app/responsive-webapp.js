...
class ResponsiveWebapp extends Component {
          ...
          <Row className="main-row">
            <Col className="sidebar" md={4} sm={6}>
              {/*
                ...
                to skip to the primary page content (tabindex = -1 needed for programmatic navigation skip).
  ...
  renderMobileView = () => {
    ...
    return (
      // <main> Needed for accessibility checks.
      // Tabindex of -1 required for programmatic navigation skip.
      <main tabIndex={-1}>
        <PopupWrapper content={popupContent} hideModal={this._hidePopup} />
        <MobileMain />
      </main>
