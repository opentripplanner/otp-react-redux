...
class ResponsiveWebapp extends Component {
  ...
  componentDidUpdate (prevProps) {
    ...
    window.onpopstate = (e) => {
      ...
      if (newSearch) {
        ...
        if (this.props.activeSearchId !== newSearchId) {
          ...
          console.log('itin index changed', this.props.uiUrlParams.ui_activeItinerary, newItinIndex)
    ...
    if (!isEqual(prevProps.query, query)) {
      ...
      // current one. This will determine whether a search needs to be made, the
  ...
  /**
   * Handles URL change and redirecting app to appropriate content (e.g., viewed
   * route or stop).
   */
