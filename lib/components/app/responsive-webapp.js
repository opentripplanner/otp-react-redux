...
class ResponsiveWebapp extends Component {
  ...
  componentDidUpdate (prevProps) {
      ...
      Object.keys(planParams)
        .forEach(key => {
          ...
          if (paramIsDifferent) {
            ...
            console.log('diff param', key, planParams[key], query[key])
          }
        })
      if (hasChangedParam) {
    ...
    if (!isEqual(location.pathname, prevProps.location.pathname)) {
      // console.log('handle pathname change', prevProps.location.pathname, location.pathname, window.location.hash)
    ...
    if (!isEqual(this.props.uiUrlParams, prevProps.uiUrlParams)) {
      // console.log('handle ui params change', this.props.uiUrlParams)
  ...
  componentDidMount () {
    ...
    if (location && location.search) {
      ...
      // in the URL.
      console.log('setting query from URL search')
      this.props.parseUrlQueryString(location.search)
    }
    console.log('handle pathname change (on mount)', this.props.location.pathname, window.location.hash)
    this._handleUrlChange(this.props)
  }
