...
import supportLoggedInUser from '../user/support-logged-in-user'
        ...
        <div>
          <Switch>
            <Route
              ...
              render={() => supportLoggedInUser(<WebappWithRouter {...this.props} />)}
            />
            <Route
              path={'/account/welcome'}
              component={(routerProps) => {
                const props = this._combineProps(routerProps)
                return supportLoggedInUser(<UserAccountScreen skipIfExistingUser {...props} />, true)
              }}
            />
            <Route
              path={'/account'}
              component={(routerProps) => {
                const props = this._combineProps(routerProps)
                return supportLoggedInUser(<UserAccountScreen {...props} />, true)
              }}
            />
            <Route
              path={'/signedin'}
