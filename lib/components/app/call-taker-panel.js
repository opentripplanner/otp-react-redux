...
const FormattedMessageWithSpace = styled(FormattedMessage)`
  &::after {
    margin: 0 0.125em;
  }
`
            ...
            <div className='advanced-search-options-container'>
              {groupSize !== null && maxGroupSize &&
                <span className='pull-right'>
                  <FormattedMessageWithSpace id='components.CallTakerPanel.groupSize' />
                  <input
                    max={maxGroupSize}
                    min={0}
              ...
              <Button
                ...
                <i className={`fa fa-caret-${expandAdvanced ? 'up' : 'down'}`} />
