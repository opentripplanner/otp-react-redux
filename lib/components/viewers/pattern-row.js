    ...
    return (
      <div className='route-row' role='table'>
        ...
        <div className='header' role='row'>
          {/* route name */}
          <div className='route-name' role='columnheader'>
          ...
          {this.state.expanded && (
            <div id={`route-${routeName}`}>
              <div className='trip-table' role='table'>
                ...
                <div className='header' role='row'>
                  <div aria-label='route' className='cell' role='columnheader' />
                  <div aria-sort='descending' className='cell time-column' role='columnheader'>DEPARTURE</div>
                  <div className='cell status-column' role='columnheader'>STATUS</div>
                </div>
                ...
                {hasStopTimes &&
                  sortedStopTimes.map((stopTime, i) => {
                    ...
                    return (
                      ...
                      >
                        <div className='cell' role='cell'>To {stopTime.headsign}</div>
