...
class RouteViewer extends PureComponent {
  static propTypes = {
            ...
            .map(route => {
              ...
              return (
                <RouteRow
                  ...
                  operator={operator}
                  route={route}
                  isActive={this._isActiveRoute(route)}
...
class RouteRow extends Component {
  ...
  _onClick = () => {
    const { isActive, route, findRoute, setViewedRoute } = this.props
    if (isActive) {
