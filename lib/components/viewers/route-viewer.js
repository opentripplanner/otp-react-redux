...
class RouteRow extends PureComponent {
  ...
  render () {
    ...
    return (
      <StyledRouteRow isActive={isActive} ref={this.activeRef} routeColor={backgroundColor}>
        <RouteRowButton
        ...
        >
          ...
          <ModeIconElement>
            <ModeIcon aria-label={getModeFromRoute(route)} height={22} mode={getModeFromRoute(route)} style={{fill: isActive && color}} width={22} />
          </ModeIconElement>
          <RouteNameElement
