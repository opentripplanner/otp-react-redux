    ...
    return (
      <div className='route-viewer'>
        ...
        <div className='route-viewer-header'>
          ...
          <div><FormattedMessage id='components.RouteViewer.details' /></div>
    ...
    return (
      <StyledRouteRow isActive={isActive}>
        ...
        >
          ...
          <ModeIconElement>
            <ModeIcon aria-label={getModeFromRoute(route)} height={22} mode={getModeFromRoute(route)} width={22} />
          </ModeIconElement>
          <RouteNameElement
        ...
        >
          {isActive && (
            <RouteDetails>
              {route.url ? (
                <a className='routeDetails' href={route.url} target='_blank'>
                  Route Details
                </a>
              ) : (
                <FormattedMessage id='components.RouteViewer.noRouteUrl' />
              )}
            </RouteDetails>
          )}
        </VelocityTransitionGroup>
