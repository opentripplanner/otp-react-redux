...
class RouteDetails extends Component {
  ...
  state = {
    vehiclePositionRefreshTimer: null
  }
  ...
  componentDidMount = () => {
    ...
    this.setState({
      vehiclePositionRefreshTimer: setInterval(
        this.refreshVehiclePositions,
  ...
  componentWillUnmount = () => {
    ...
    const { vehiclePositionRefreshTimer } = this.state
    if (vehiclePositionRefreshTimer) {
      clearInterval(vehiclePositionRefreshTimer)
      this.setState({ vehiclePositionRefreshTimer: null })
    }
  }
