...
export const StyledRouteViewer = styled.div`
  animation: ${(props) => props.patternView && backgroundColorTransition} 200ms
      linear,
    ${(props) => (props.fade ? fadeOut : 'none')} 100ms linear;
  ...
  & > * {
    animation: ${(props) => props.patternView && fadeIn} 300ms linear forwards;
