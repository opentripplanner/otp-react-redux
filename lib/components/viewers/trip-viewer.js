...
const TripDescription = styled.div`
  ...
  // border-left: 4px solid rgb(19, 193, 193);
            ...
            {tripData &&
              ...
              tripData.stops.map((stop, i) => {
                ...
                if (viewedTrip.fromIndex === i) {
                  stopLabel = intl.formatMessage({
                    id: 'components.tripviewer.startOfTrip'
                  })
                }
                if (viewedTrip.toIndex === i) {
                  stopLabel = intl.formatMessage({
                    id: 'components.tripviewer.endOfTrip'
                  })
                }
                ...
                return (
                  <Stop aria-label={stopLabel} key={i}>
