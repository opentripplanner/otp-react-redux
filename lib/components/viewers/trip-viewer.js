...
`
const InvisibleAccessibilityLabel = styled.span`
  height: 0;
  overflow: 0;
  width: 0;
`
            ...
            {tripData &&
              ...
              tripData.stops.map((stop, i) => {
                ...
                if (viewedTrip.fromIndex === i) {
                  stopLabel = 'components.TripViewer.startOfTrip'
                }
                if (viewedTrip.toIndex === i) {
                  stopLabel = 'components.TripViewer.endOfTrip'
                }
                  ...
                  <Stop key={i}>
                    <FlexWrapper width="80%">
                      <FlexWrapper>
                        {/* the departure time */}
                        {stopLabel && (
                          <InvisibleAccessibilityLabel>
                            <FormattedMessage id={stopLabel} />
                          </InvisibleAccessibilityLabel>
                        )}
