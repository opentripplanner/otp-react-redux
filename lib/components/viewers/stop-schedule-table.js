...
import { getFormattedStopTime, getSecondsUntilDeparture, getStopTimesByPattern } from '../../util/viewer'
...
class StopScheduleTable extends Component {
  ...
  _scrollToFirstDeparture = () => {
    this.firstDepartureRef.current.scrollIntoView()
  }
  ...
  render () {
    ...
    if (mergedStopTimes.length) {
      // Search closest departure starting from the last stop time for this pattern.
