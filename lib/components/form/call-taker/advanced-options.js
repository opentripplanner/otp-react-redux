      ...
      <div>
        <div style={{alignItems: 'center', display: 'flex', justifyContent: 'space-between'}}>
          <label style={{fontWeight: '400'}}>
            <FormattedMessage id='components.AdvancedOptions.maxWalk' values={{unitsString}} />
            <input
              min='0'
          ...
          {hasBike(mode)
            ? <label style={{fontWeight: '400'}}>
              <FormattedMessage id='components.AdvancedOptions.maxBike' values={{unitsString}} />
              <input
                min='0'
        ...
        <Select
          ...
          placeholder={intl.formatMessage({id: 'components.AdvancedOptions.preferredRoutes'})}
        ...
        <Select
          ...
          options={this.state.routeOptions}
          placeholder={intl.formatMessage({id: 'components.AdvancedOptions.bannedRoutes'})}
          value={bannedRoutes} />
      </div>
    )
  }
...
export default connect()(injectIntl(AdvancedOptions))
