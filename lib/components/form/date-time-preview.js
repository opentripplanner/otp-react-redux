...
class DateTimePreview extends Component {
  ...
  render () {
    const { caret, date, editButtonText, time, departArrive, routingType, startTime, endTime, timeFormat, dateFormat } = this.props
    ...
    const summary = (
      <div className='summary'>
        <i className='fa fa-calendar' /> {moment(date).calendar(null, { sameElse: dateFormat }).split(' at')[0]}
        <br />
