          ...
          <Col xs={12}>
            <ButtonGroup justified>
              <ButtonGroup key='walk-only' style={{ width: 45 }}>
                ...
                >
                  <div style={{ display: 'inline-block', marginRight: 5, width: 12, height: 12, verticalAlign: 'middle', fill: mode === 'WALK' ? '#fff' : '#000' }}>{getModeIcon('WALK', icons)}</div>
              ...
              <ButtonGroup key='bike-only' style={{ width: 45 }}>
                ...
                >
                  <div style={{ display: 'inline-block', marginRight: 5, width: 12, height: 12, verticalAlign: 'middle', fill: !modeHasTransit && hasBike(mode) ? '#fff' : '#000' }}>{getModeIcon('BICYCLE', icons)}</div>
