...
class LocationField extends Component {
  ...
  // FIXME: Using onBlur seems like the proper way to hide the menu
  // but it causes issues when trying to click a menu item, i.e., the menu
  // disappears before the item can be selected (although there is no issue
  // with selecting the item via keyboard). There are still cases where the menu
  // stays visible when it shouldn't, e.g., tabbing from the origin input to the
  // destination input leaves the origin input open.
