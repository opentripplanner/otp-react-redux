...
export default function connectLocationField (StyledLocationField, options = {}) {
  ...
  const mapDispatchToProps = (dispatch, ownProps) => {
    const dispatchActions = {
      ...
      getCurrentPosition: (setAsType, onSuccess) =>
        locationActions.getCurrentPosition(ownProps.intl, setAsType, onSuccess),
      ...actions
    }

    Object.entries(dispatchActions).forEach(([key, fn]) => {
