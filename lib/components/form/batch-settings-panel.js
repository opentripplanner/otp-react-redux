...
import { StyledBatchSettingsPanel } from './styled'
import UserTripSettings from './user-trip-settings'

class BatchSettingsPanel extends Component {
  ...
  render () {
    ...
    return (
      <div className='settings-selector-panel' style={style}>
        <div className='modes-panel'>
          {showUserSettings && <UserTripSettings />}

          <StyledBatchSettingsPanel
            ModeIcon={ModeIcon}
            queryParams={query}
...
export default connect(mapStateToProps, mapDispatchToProps)(BatchSettingsPanel)
