      ...
      <div className='settings-selector-panel'>
          ...
          <Col xs={12}>
            <ButtonGroup justified>
              <ButtonGroup key='transit' style={{ width: '100%' }}>
                <Button style={{ width: '100%', height: 50, border: `1px solid black`, background: 'none', paddingTop: 5 }}
                ...
                >
                  <div>
                    ...
                    <div style={{ display: 'inline-block', fontSize: 28, fontWeight: modeHasTransit ? 500 : 300, verticalAlign: 'middle', color: '#000' }}>Take Transit</div>
                  </div>
                </Button>
              </ButtonGroup>
            </ButtonGroup>
        ...
        <div className='modes-panel'>
          ...
          <Row className='button-row'>
            <Col xs={2} />
            <Col xs={4}>
              <Button style={{ width: '100%', border: `1px solid black`, background: 'none' }}
                onClick={this._setWalkOnly}
              >
                <div style={{ display: 'inline-block', marginRight: 5, width: 16, height: 16, verticalAlign: 'middle' }}>{getModeIcon('WALK', icons)}</div>
                <span style={{ verticalAlign: 'middle', fontWeight: mode === 'WALK' ? 500 : 300 }}>Walk Only</span>
              </Button>
            </Col>
            <Col xs={4}>
              <Button style={{ width: '100%', border: `1px solid black`, background: 'none' }}
              ...
              >
                <div style={{ display: 'inline-block', marginRight: 5, width: 16, height: 16, verticalAlign: 'middle' }}>{getModeIcon('BICYCLE', icons)}</div>
                <span style={{ verticalAlign: 'middle', fontWeight: !modeHasTransit && hasBike(mode) ? 500 : 300 }}>Bike Only</span>
              </Button>
            </Col>
            <Col xs={2} />
          </Row>
