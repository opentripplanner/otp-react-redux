 ...
 */
const connectLink = RoutingComponent =>
...
// and export.
export default {
  Link: connect(mapStateToProps)(connectLink(Link)),
  LinkContainer: connect(mapStateToProps)(connectLink(LinkContainer)),
  Redirect: connect(mapStateToProps)(connectLink(Redirect))
}
