...
class BaseMap extends Component {
  ...
  _onClick = (e) => {
    ...
    if (!this.props.isFromSet) this.props.setLocation({type: 'from', location})
    else if (!this.props.isToSet) this.props.setLocation({type: 'to', location})
  }
...
const mapDispatchToProps = {setLocation, updateMapState}
