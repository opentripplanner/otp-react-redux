...
import FormattedTransitOverlay from '../util/formatted-transit-overlay'
  ...
  return (
    <Tooltip direction={direction} permanent={permanent}>
      <span>
        ...
        */}
        <FormattedMessage id='components.TransitVehicleOverlay.realtimeVehicleInfo'
          values={{
