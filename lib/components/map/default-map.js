...
import IntermediatePlacesOverlay from './intermediate-places-overlay'
    ...
    return (
      <MapContainer>
        ...
        >
          ...
          <EndpointsOverlay />
          <IntermediatePlacesOverlay />
          <RouteViewerOverlay
            // FIXME: Remove once https://github.com/opentripplanner/otp-ui/issues/129
            // is resolved/released.
            leafletPath={{color: '#000', opacity: 1, weight: 4}} />
          <StopViewerOverlay />
          <TransitiveOverlay />
          <TripViewerOverlay />
