...
const iconPixels = 32
const iconPadding = 8
const borderPixels = 1
const caretVisibleHeight = caretPixels / 1.4142 // Math.sqrt(2)
const caretMarginPixels = (iconPixels - caretPixels) / 2
const bubblePixels = iconPixels + iconPadding + 2 * borderPixels
...
class EnhancedStopMarker extends Component {
  ...
  render () {
    ...
    const icon = divIcon({
      ...
      iconAnchor: [bubblePixels / 2 + 4, bubblePixels + caretVisibleHeight + 8]
    })
