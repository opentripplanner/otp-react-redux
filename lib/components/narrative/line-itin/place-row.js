  ...
  _createLegLine (leg) {
    switch (leg.mode) {
      ...
      case 'MICROMOBILITY_RENT':
        return <div className='leg-line leg-line-vehicle' />
      default:
    ...
    return (
      <div className='place-row' key={this.rowKey++}>
        ...
        <div className='place-details'>
          ...
          {/* Place subheading: rented vehicle pickup */}
          {leg && leg.rentedVehicle && (
            <div className='place-subheader'>
              Pick up {leg.from.networks ? leg.from.networks.join('/') : 'rented vehicle'} {leg.from.name}
            </div>
          )}
