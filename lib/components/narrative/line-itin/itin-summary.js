...
export class ItinerarySummary extends Component {
  ...
  render () {
    ...
    console.log('TRANSFERS:', itinerary.transfers)
    console.log('maxTNCFare:', maxTNCFare, 'min TNC Fare:', minTNCFare)
    return (
      <Container onClick={this._onSummaryClicked}>
        <Details>
          ...
          <Detail>
            <FormattedMessage id='components.ItinerarySummary.transfers' values={{transfers: itinerary.transfers}} />
          </Detail>
