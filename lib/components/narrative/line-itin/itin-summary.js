...
export class ItinerarySummary extends Component {
  ...
  render () {
    ...
    const formattedStartTime = moment(itinerary.startTime).valueOf() + timeOptions.offset
    const formattedEndTime = moment(itinerary.endTime).valueOf() + timeOptions.offset
