...
class TabButton extends Component {
  ...
  render() {
    ...
    const { maxTNCFare, minTNCFare, transitFare } = calculateFares(itinerary)
    // TODO: support non-USD
    const minTotalFare = minTNCFare * 100 + transitFare
    const mustCallAhead = itinerary.legs.some(coreUtils.itinerary.isOptional)
