...
class NarrativeRoutingResults extends Component {
  ...
  render () {
    const { customIcons, error, itineraryClass, pending, routingType, itineraries, mainPanelContent } = this.props
    ...
    return (
      routingType === 'ITINERARY'
        ? <TabbedItineraries itineraryClass={itineraryClass} itineraries={itineraries} />
