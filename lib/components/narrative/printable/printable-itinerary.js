...
import { relativeDirectionString } from '../../../util/itinerary'
  ...
  render () {
    ...
    return (
      <div className='leg'>
        ...
        <div className='leg-body'>
          <div className='leg-header'>
            <b>{leg.mode}</b> to <b>{leg.to.name}</b>
          </div>
          <div className='leg-details'>
            {leg.steps.map((step, k) => {
              return (
                <div className='leg-detail'>{relativeDirectionString(step.relativeDirection)} on <b>{step.streetName}</b></div>
              )
            })}
          </div>
        </div>
