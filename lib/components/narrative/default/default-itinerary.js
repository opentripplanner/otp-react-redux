...
import { getFlexAttributes } from '../metro/attribute-utils'
import {
  Icon,
  IconWithText,
...
const { getItineraryCost, isTransitLeg } = coreUtils.itinerary
...
class DefaultItinerary extends NarrativeItinerary {
  ...
  render() {
    ...
    const { isCallAhead, isContinuousDropoff, isFlexItinerary } =
