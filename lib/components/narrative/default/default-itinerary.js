...
class DefaultItinerary extends NarrativeItinerary {
  ...
  render () {
    ...
    const isOptional = itinerary.legs.some(coreUtils.itinerary.isOptional)
    const isCallAhead = itinerary.legs.some(coreUtils.itinerary.isContinuousDropoff)
    ...
    return (
      ...
      >
        ...
        >
          ...
          {isFlexItinerary && <FlexIndicator isCallAhead={isCallAhead} isOptional={isOptional} />}
