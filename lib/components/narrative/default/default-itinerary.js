...
class DefaultItinerary extends NarrativeItinerary {
  ...
  render () {
    ...
    const isCallAhead = itinerary.legs.some(coreUtils.itinerary.isOptional)
    ...
    return (
      ...
      >
        ...
        >
          ...
          {isFlexItinerary && <FlexIndicator isCallAhead={isCallAhead} isContinuousDropoff={isContinuousDropoff} shrink={active && !expanded} />}
