...
const mapStateToProps = (state) => {
  ...
  // Array may be modified via sorting.
  ...
  // Sort itineraries if needed
  const sortedItineraries = sortItinerariesInPlaceIfNeeded(itineraries, state)

  // Add carbon info, if available.
  const itinsWithCo2 = addCarbonInfoToAll(sortedItineraries, co2)
