...
function addCarbonInfoToAll(itineraries, co2Config, baselineCo2) {
  return (
...
const mapStateToProps = (state) => {
  ...
  if (mergeItineraries) {
    ...
    allItineraries = mergedItineraries = itineraries.map((itin, index) => ({
      ...itin,
      index
    }))
  }
  ...
  const mergedItinerariesWithCo2 = addCarbonInfoToAll(
    mergedItineraries,
    co2,
    baselineCo2
  )
  const allItinerariesWithCo2 = addCarbonInfoToAll(
    allItineraries,
    co2,
    baselineCo2
  )
  ...
  return {
    ...
    groupTransitModes,
    hideFirstResultByDefault,
    itineraries: allItinerariesWithCo2,
    itineraryIsExpanded,
    ...
    mergedItineraries: mergedItinerariesWithCo2,
    modes,
    pending,
