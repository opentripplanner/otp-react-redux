...
class TripTools extends Component {
  ...
  render () {
    const { buttonTypes, intl, reactRouterConfig, reportConfig } = this.props
      ...
      switch (type) {
        ...
        case 'START_OVER':
          ...
          buttonComponents.push(
            ...
            <LinkButton
              icon='undo'
              text={intl.formatMessage({id: 'components.TripTools.startOver'})}
              url={startOverUrl}
            />
          )
          break
...
export default connect(mapStateToProps)(injectIntl(TripTools))
