      ...
      switch (type) {
        ...
        case 'START_OVER':
          ...
          buttonComponents.push(
            ...
            <LinkButton
              icon='undo'
              text={<FormattedMessage id='components.TripTools.startOver' />}
              url={startOverUrl}
            />
          )
          break
      ...
      <div>
        ...
        >
          {this.state.showCopied
            ? (
              <span>
                <IconWithSpace type='check' />
                <FormattedMessage id='components.TripTools.linkCopied' />
              </span>
            )
            : (
              <span>
                <IconWithSpace type='clipboard' />
