    ...
    const innerContent = <div className='realtime-alert'>
      <div className='content'>
                ...
                values={{
                  ...
                  normalDuration: (
                    <FormattedDuration
                      ...
                      // FIXME: move id and zeroHoursId inside component.
                      id='common.time.tripDurationFormat'
                      zeroHoursId='common.time.tripDurationFormatZeroHours'
                    />
                  ),
                  routes: (
                    <FormattedList
        ...
        <div>
          ...
          >
            <FormattedMessage
              id={`components.RealtimeAnnotation.${useRealtime ? 'ignore' : 'apply'}ServiceDelays`}
            />
          </Button>
        </div>
      </div>
