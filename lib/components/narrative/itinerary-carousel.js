...
class ItineraryCarousel extends Component {
  ...
  _onLeftClick = () => {
    ...
    setActiveItinerary(
      activeItinerary === 0 ? itineraries.length - 1 : activeItinerary - 1
    )
  }
  ...
  _onRightClick = () => {
    const { activeItinerary, itineraries, setActiveItinerary } = this.props
    setActiveItinerary(
      activeItinerary === itineraries.length - 1 ? 0 : activeItinerary + 1
    )
  }
  ...
  render() {
    const { activeItinerary, expanded, hideHeader, itineraries, pending } =
      this.props
      ...
      <div className="options itinerary">
        {hideHeader ? null : (
          <div className="header carousel-header">
            ...
            <div className="text-center carousel-header-text">
        ...
        <SwipeableViews index={activeItinerary} onChangeIndex={this._onSwipe}>
