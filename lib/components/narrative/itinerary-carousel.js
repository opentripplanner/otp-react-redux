...
const mapStateToProps = (state, ownProps) => {
  ...
  if (activeSearch && activeSearch.planResponse && activeSearch.planResponse.plan) {
    itineraries = activeSearch.planResponse.plan.itineraries
  } else if (activeSearch && activeSearch.profileResponse && activeSearch.profileResponse.otp) {
    profileOptions = activeSearch.profileResponse.otp.profile
