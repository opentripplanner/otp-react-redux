...
class TripNotificationsPane extends Component {
  ...
  render () {
    ...
    if (areNotificationsDisabled) {
      ...
      // Set the delay threshold selector to target the departure or arrival
      // variance field depending on whether the trip is 'depart at' or 'arrive by' a given time.
      const thresholdField = values.arriveBy ? 'arrivalVarianceMinutesThreshold' : 'departureVarianceMinutesThreshold'
      notificationSettingsContent = (
        <>
