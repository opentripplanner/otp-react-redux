...
import GlyphIcon from '../../util/glyph-icon'
    ...
    if (areNotificationsDisabled) {
      notificationSettingsContent = (
        <Alert bsStyle='warning'>
          <p>
            <GlyphIcon glyph='alert' withSpace />
            <strong>
            ...
            <FormattedMessage
              ...
              values={
                notificationChannel === 'email'
                  ? {channel: <FormattedMessage id='components.TripNotificationsPane.emailChannel' />}
                  : {channel: <FormattedMessage id='components.TripNotificationsPane.smsChannel' />}
              }
            />
          </h4>
