        ...
        <TripPanelFooter>
          <Button onClick={this._handleTogglePauseMonitoring}>
            {trip.isActive
              ? (
                <>
                  <GlyphIcon glyph='pause' withSpace />
                  <FormattedMessage id='components.SavedTripList.pause' />
                </>
              )
              : (
                <>
                  <GlyphIcon glyph='play' withSpace />
          ...
          <Button onClick={this._handleEditTrip}>
            <GlyphIcon glyph='pencil' withSpace />
            <FormattedMessage id='components.SavedTripList.edit' />
          </Button>
          <Button onClick={this._handleDeleteTrip}>
            <GlyphIcon glyph='trash' withSpace />
            <FormattedMessage id='components.SavedTripList.delete' />
          </Button>
        </TripPanelFooter>
      </Panel>
    )
