...
export default function nextTripNotPossibleRenderer(monitoredTrip) {
  ...
  data.headingText = (
    <FormattedMessage id="components.TripStatusRenderers.nextTripNotPossible.heading" />
  )
  data.bodyText = (
    <FormattedMessage id="components.TripStatusRenderers.nextTripNotPossible.description" />
  )
