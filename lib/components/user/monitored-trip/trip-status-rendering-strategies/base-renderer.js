...
export default class BaseRenderer {
  ...
  constructor (monitoredTrip) {
    ...
    this.matchingItinerary = this.journeyState && this.journeyState.matchingItinerary
  }
  ...
  /**
   * Returns true if the monitored trip exists and journey state exists and at
   * least one alert exists in the journy state's matching itinerary.
   */
  hasMoreThanOneAlert () {
   ...
   */
  shouldRenderAlerts () {
    return this.hasMoreThanOneAlert()
  }
