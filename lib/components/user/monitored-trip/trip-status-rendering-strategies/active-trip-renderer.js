...
import { PulsingRss } from '../../../util/styledIcon'
...
export default function activeTripRenderer({
  ...
  if (data.journeyState.hasRealtimeData) {
    ...
    data.panelBsStyle = SUCCESS_COLOR_VARIABLES.info
    data.headingText = (
