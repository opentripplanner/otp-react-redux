...
export default function upcomingTripRenderer ({
  ...
  data.bodyText = (
    <FormattedMessage
      ...
      values={{
        monitoringStart: monitoringStartMoment.format(timeFormat),
        tripStart: tripStartMoment.format(timeFormat)
      }}
    />
  )
    ...
    data.headingText = (
      <FormattedMessage
        ...
        values={{
          ...
          tripDate: tripStartMoment,
          tripTime: tripStartMoment.format(timeFormat)
        }}
      />
    )
