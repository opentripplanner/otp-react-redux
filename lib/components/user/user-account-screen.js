...
class UserAccountScreen extends Component {
  ...
  _handleLocationsChange = newLocations => {
    this._updateUserState({ savedLocations: newLocations })
  }
  ...
  _makePanes = () => {
    ...
    const verifyPhone = <PhoneVerificationPane />

    const locations = (
      <FavoriteLocationsPane
        locations={savedLocations}
        onLocationsChange={this._handleLocationsChange}
      />
    )

    const finish = <AccountSetupFinishPane />
