...
import FavoriteLocationsPane from './favorite-places-pane'
  ...
  render () {
    ...
    const placesPane = (
      <FavoriteLocationsPane
        ...
        onEditPlaceAddress={this._handleAddressChange} // Fix this!!
    ...
    return (
      // TODO: Refactor header (was copied from example.js), and mobile view.
      <div class='otp'>
