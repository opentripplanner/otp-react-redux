...
class UserAccountScreen extends Component {
  ...
  _handleSendPhoneVerificationCode = ({ validationCode: code }) => {
        ...
        >
          {
            ...
            (formikProps) => (
              <>
                ...
                {/* Additional (regular) forms for the phone number editor (Forms cannot be nested.) */}
                <form id="phone-change-form" noValidate />
              </>
            )
          }
        </Formik>
