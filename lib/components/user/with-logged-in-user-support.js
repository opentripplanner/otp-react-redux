...
class UserLoaderScreen extends Component {
   ...
   * @returns true if the logged-in user has passed Auth0 authentication and state.user.loggedInUser has not been set; false otherwise.
   */
  shouldBeFetchingUser = () => {
  ...
  render () {
    ...
    if (requireLoggedInUser && this.shouldBeFetchingUser()) {
