...
import { convertToLegacyLocation, isOtpMiddleware } from '../../../util/user'
...
class PlaceShortcut extends Component {
  ...
  _onSelect = () => {
    const { index, intl, isOtpMiddleware, place, routeTo } = this.props
...
const mapStateToProps = (state) => {
  ...
  return {
    isOtpMiddleware: isOtpMiddleware(persistence),
    query
  }
}
