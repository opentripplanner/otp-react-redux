...
import { CREATE_ACCOUNT_PLACES_PATH, PLACE_NAME_MAX_LENGTH } from '../../../util/constants'
...
class FavoritePlaceScreen extends Component {
  ...
  _handleDelete = async placeToSave => {
    ...
    toastPromise(deleteLoggedInUserPlace(placeIndex, intl), toastMessageOnPlaceChanged(placeToSave, intl, 'Deleted'), intl)
    // Return to previous location when done.
    navigateBack()
  }
  ...
  _getFullValidationSchema = (places, place) => {
    ...
    clonedSchemaShape.name = yup.string()
      ...
      .max(PLACE_NAME_MAX_LENGTH, 'placename-too-long') // text constant for components.FavoritePlaceScreen.nameTooLong
  ...
  render () {
    ...
    console.log('FavoritePlaceScreen.render:::::', place)
              ...
              return (
                <Form noValidate>
                  ...
                  <FormNavigationButtons
                    ...
                    extraButton={!isNewPlace && place.address && {content: (
