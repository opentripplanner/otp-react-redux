        ...
        <FlexContainer>
          ...
          <FlexFormGroup validationState={errorStates.address}>
            <PlaceLocationField
              ...
              // Add a flag for mobile views to adjust dropdown menu position/width.
              // The component's 'static' prop is not suitable for mobile views here, as it would
              // show the list of places over the Back/Save buttons, making these buttons unreachable.
              isMobile={isMobile()}
