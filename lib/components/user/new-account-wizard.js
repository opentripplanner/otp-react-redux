 ...
 */
const NewAccountWizard = ({ onComplete, onCreate, onSendPhoneVerification, onStartPhoneVerification, panes, userData }) => {
  const {
    hasConsentedToTerms,
  ...
  const paneSequence = {
    ...
    notifications: {
      ...
      prevId: 'terms',
      props: { onSendPhoneVerification, onStartPhoneVerification },
