...
import FavoriteLocationField from '../form/favorite-location-field'
  ...
  render () {
    ...
    return (
      <FormGroup>
        <InputGroup>
          {iconControl}
          {/* wrapping element with z-index override needed for showing location menu on top of other controls. */}
          <span className='form-control' style={{ zIndex: 'inherit' }}>
