  ...
  render () {
    ...
    return (
      <div>
            ...
            <div>
              ...
              {shouldVerifyPhone && (
                <div>
                  ...
                  <Button onClick={this._handleRevertPhoneNumber} style={{marginLeft: '4px'}}>Revert number</Button>
                </div>
              )}
            </div>
          )}
        ...
        <Modal show={isVerificationPending}>
          <Modal.Header>
          ...
          <Modal.Body>
            ...
            <p>
              <Button bsStyle='link' onClick={this._handleStartPhoneVerification}>Request a new code</Button>
            </p>
          </Modal.Body>
