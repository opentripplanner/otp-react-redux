            ...
            <div>
              <FormGroup validationState={phoneFieldValidationState}>
                ...
                <FormControl
                  ...
                  // Fake phone number, see https://en.wikipedia.org/wiki/555_(telephone_number)
              ...
              {shouldVerifyPhone && (
                <ButtonStrip>
                  ...
                  {initialPhoneNumber.length !== 0 && <Button onClick={this._handleRevertPhoneNumber}>Revert number</Button>}
                </ButtonStrip>
              )}
            </div>
          )}
