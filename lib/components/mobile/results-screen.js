...
class MobileResultsScreen extends Component {
  ...
  _optionClicked = () => this.setState({ expanded: !this.state.expanded })

  _toggleRealtime = () =>
    this.props.setUseRealtimeResponse({ useRealtime: !this.props.useRealtime })
  ...
  render () {
    ...
    const locationsSummary = (
      <Row xs={12}
        ...
        style={{ padding: '4px 0px', margin: 0, marginLeft: '-5px' }}>
    ...
    return (
      <MobileContainer>
        ...
        <ItineraryCarousel
          ...
          activeItineraryIndex={activeItineraryIndex}
          expanded={expanded}
