    ...
    return (
      <StyledMobileContainer>
        ...
        */}
        ...
        <div className='results-map' style={{bottom: mapExpanded ? 0 : '60%', display: itineraryExpanded ? 'none' : 'inherit'}}>
        ...
        {hasNoResult
          ? <ResultsError error={errors[0]} />
          : (
            <div className='mobile-narrative-container' style={{display: mapExpanded ? 'none' : 'inherit', top: itineraryExpanded ? '100px' : '40%'}}>
              <NarrativeItineraries
                containerStyle={{
                  background: '#fff',
                  display: 'flex',
