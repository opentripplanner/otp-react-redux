...
const ResultsMap = styled.div`
  ...
  display: ${(props) =>
    props.visible ? 'inherit' : 'none'}; // remove the inherit, change to block
  left: 0;
  // position: fixed;
  right: 0;
  top: 100px;
...
const BatchMobileResultsScreen = ({
  ...
  return (
    <StyledMobileContainer>
      ...
      <button onClick={toggleBatchResultsMap}>hello world</button>
