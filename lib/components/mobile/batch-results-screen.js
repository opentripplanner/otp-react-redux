...
class BatchMobileResultsScreen extends Component {
  ...
  _handleToggleDetailedItinerary = itineraryExpanded => {
          ...
          <div className='results-map' style={{flexGrow: 1, position: 'unset'}}>
            ...
            <div style={{position: 'relative', width: '100%', height: '100%'}}>
              ...
              <Button
                ...
                style={{position: 'absolute', bottom: 16, right: 10, zIndex: 999999}}
              >
        ...
        {!mapExpanded && (
          ...
          >
            <NarrativeItineraries
              ...
              onToggleDetailedItinerary={this._handleToggleDetailedItinerary}
            />
          </div>
        )}
