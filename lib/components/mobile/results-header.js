...
class ResultsHeader extends Component {
  ...
  render() {
    ...
    const headerText = hasNoResult ? (
      <FormattedMessage id="components.ResultsHeader.noTripFound" />
    ) : resultCount ? (
      <FormattedMessage
      ...
      <FormattedMessage id="components.ResultsHeader.waiting" />
    )
...
const mapStateToProps = (state, ownProps) => {
  ...
  const response = !activeSearch ? null : activeSearch.response
