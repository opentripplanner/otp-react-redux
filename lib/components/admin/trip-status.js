          ...
          <Para className="field-trip-time-edit">
            <EditableSection
              ...
              onChange={(_, newParams) =>
                this.props.setFieldTripTime(
                  request,
                  newParams.arriveTime,
                  intl,
                  'SET_DESTINATION_ARRIVAL_TIME'
...
const mapDispatchToProps = {
  ...
  setFieldTripTime: fieldTripActions.setFieldTripTime,
