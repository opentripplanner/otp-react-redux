...
import { parseDate, searchToQuery, toTimeZone } from '../../util/call-taker'
    ...
    if (inProgress) {
      ...
      return (
        <div>
          ...
          <Icon className="fa-flip-horizontal" type="phone" /> [Active call]
          <br />
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            <Icon type="clock-o" /> {this._getCallDuration()}
          </small>
        </CallRecordButton>
        {expanded ? (
          <QueryList>
