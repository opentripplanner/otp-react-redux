...
/**
 * Get one of the realtime states (on-time, late, etc.) if a leg/stoptime is
...
export function getRouteColorBasedOnSettings(operator = {}, route = {}) {
  const { routeColor } = getColorAndNameFromRoute(operator, route)

  if (operator.colorMode === 'disabled') {
