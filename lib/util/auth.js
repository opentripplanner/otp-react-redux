...
/**
 * Gets the host and port from which the UI is running for Auth0 redirect.
 */
  ...
  return {
    ...
    onRedirectCallback: appState => {
      if (appState && appState.returnTo) {
        /**
         * Immediately after successful Auth0 login, the user will be redirected to the MOD UI URL with no search.
         * We want to redirect to the URL just before the Auth0 operation (stored in appState.returnTo),
