  ...
  return {
    ...
    onRedirectCallback: appState => {
      if (appState && appState.returnTo) {
        ...
        /**
         * Careful!
         * - When redirecting from login from main screen,
         *     then returnTo is set by us to a URL string.
         ...
         */
        const returnToIsString = typeof appState.returnTo === 'string'
        const isNewUser = returnToIsString && appState.returnTo.endsWith('/#/')
        ...
        } else if (returnToIsString) {
          // alert('Existing user')
          window.location.replace(appState.returnTo)
        } else {
          // TODO: If the user was trying to access the account page, redirect thme there
