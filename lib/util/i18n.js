...
/**
 * Reformat some locales to match RFC5646, so they are recognized by react-intl and other tools.
 * zh-Hant must be entered as 'zh_Hant' in config.yml, otherwise it is not parsed correctly.
 */
export function getStandardizedLocale(locale) {
