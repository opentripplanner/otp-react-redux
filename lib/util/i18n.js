...
const i18nModules = import.meta.glob('../../i18n/*.yml')
const i18nOtpUiModules = import.meta.glob('../../node_modules/@opentripplanner/**/i18n/*.yml')
...
async function loadOtpUiLocaleData(matchedLocale) {
  ...
  return merge.all(otpUiMessages.map((messages) => messages?.default))
}
