import { getJSONFromStorage } from './query'
import { getCurrentDate, getCurrentTime } from './time'
import { isTransit, isAccessMode, isCar, hasTransit, hasBike } from './itinerary'
...
let storedSettings = getJSONFromStorage('otp.defaultQuery')
