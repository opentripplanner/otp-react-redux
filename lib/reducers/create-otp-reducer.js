...
export function getInitialState(userDefinedConfig) {
  ...
  // Remove unused params from getDefaultQuery.
  // TODO: remove from core-utils.
  delete defaults.showIntermediateStops
  delete defaults.otherThanPreferredRoutesPenalty
  delete defaults.ignoreRealtimeUpdates
