...
export function findGraphQLTrip(params) {
  // Attempt an otp-2 graphQL request for the same trip before failing
  // since the otp-2 rest api doesn't return the needed fields

  // TODO: for now, this matches the OTP-1 output. In the future this should be
  // reduced to only include what is needed
  return createGraphQLQueryAction(
    `{
