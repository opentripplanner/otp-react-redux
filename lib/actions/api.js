...
export const nearbyLookupResponse = createAction('NEARBY_LOOKUP_RESPONSE')
export const nearbyLookupError = createAction('NEARBY_LOOKUP_ERROR')

export function fetchNearby(map, coords) {
  return executeOTPAction('fetchNearby', map, coords)
}
