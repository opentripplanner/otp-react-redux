 ...
 */
function executeOTPVersionSpecificAction(methodName, ...params) {
...
export function vehicleRentalQuery(
  ...
  return executeOTPVersionSpecificAction(
    'vehicleRentalQuery',
    params,
    responseAction,
    errorAction,
...
export function fetchStopInfo(stop) {
  return executeOTPVersionSpecificAction('fetchStopInfo', stop)
}
...
export function findRoute(params) {
  return executeOTPVersionSpecificAction('findRoute', params)
}

export function findPatternsForRoute(params) {
  return executeOTPVersionSpecificAction('findPatternsForRoute', params)
}
...
export function getVehiclePositionsForRoute(routeId) {
  return executeOTPVersionSpecificAction('getVehiclePositionsForRoute', routeId)
}
