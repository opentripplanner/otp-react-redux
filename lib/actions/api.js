...
export function findStopTimesForStop (params) {
  return function (dispatch, getState) {
    ...
    // TODO: parform an additional query with ^^ and without date path if the one below returns no stop times at all.
    ...
    // Clear existing stop times to prevent extra rendering of stop viewer while schedule is
