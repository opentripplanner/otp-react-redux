...
function convertRequestToSearch(config) {
  return function (tripRequest) {
    ...
    otp2QueryParams.fromPlace =
      otp2QueryParams.fromPlace?.replaceAll('}', '') || null
    otp2QueryParams.toPlace =
      otp2QueryParams.toPlace?.replaceAll('}', '') || null
    console.log(otp2QueryParams)
    return {
      canDelete: false,
      id,
