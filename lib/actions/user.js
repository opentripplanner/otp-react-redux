...
function setUser (user, fetchTrips) {
  return function (dispatch, getState) {
    const { localizedMessages } = getState().otp.ui
    const homeName = localizedMessages['common.places.home']
    const workName = localizedMessages['common.places.work']
    positionHomeAndWorkFirst(user, homeName, workName)
 ...
 */
export function saveUserPlace (place, placeIndex) {
  return function (dispatch, getState) {
