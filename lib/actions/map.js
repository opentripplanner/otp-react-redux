...
export function setLocation(payload) {
  return function (dispatch, getState) {
    ...
    // TODO: add a configuration item to allow this to be overriden on a node type basis.
...
export function onLocationSelected(
  ...
  return function (dispatch, getState) {
    if (resultType === 'CURRENT_LOCATION') {
      ...
      // Add that location to the top of the list if it was previously selected.
