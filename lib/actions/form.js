...
export function parseQueryString (queryString) {
  return function (dispatch, getState) {
    ...
    const paramString = queryString.substring(1)
    const planParams = qs.parse(paramString)
    // Convert strings to numbers/objects
    const params = planParamsToQuery(planParams)
