...
const messages = defineMessages({
  ...
  itineraryCapacityError: {
    id: 'actions.fieldTrip.itineraryCapacityError'
  },
  maxTripRequestsExceeded: {
    id: 'actions.fieldTrip.maxTripRequestsExceeded'
  },
  saveItinerariesError: {
...
export function fetchFieldTrips (intl) {
  return async function (dispatch, getState) {
    ...
    try {
      ...
      alert(
        intl.format(messages.fetchFieldTripsError, { err: JSON.stringify(err) })
      )
    }
...
export function addFieldTripNote (request, note, intl) {
  return function (dispatch, getState) {
    ...
    return fetch(`${datastoreUrl}/fieldtrip/addNote`,
      ...
      .catch(err => {
        alert(
          intl.format(messages.addNoteError, { err: JSON.stringify(err) })
        )
      })
  }
}
...
export function deleteFieldTripNote (request, noteId, intl) {
  return function (dispatch, getState) {
    ...
    return fetch(`${datastoreUrl}/fieldtrip/deleteNote`,
      ...
      .catch(err => {
        alert(
          intl.format(messages.deleteNoteError, { err: JSON.stringify(err) })
        )
      })
  }
}
  ...
  return function (dispatch, getState) {
    ...
    return fetch(`${datastoreUrl}/fieldtrip/editSubmitterNotes`,
      ...
      .catch(err => {
        alert(
          intl.format(
            messages.editSubmitterNotesError,
            { err: JSON.stringify(err) }
          )
        )
      })
...
export function saveRequestTripItineraries (request, outbound, intl) {
  return async function (dispatch, getState) {
    ...
    try {
      ...
      alert(
        intl.format(messages.saveItinerariesError, { err: JSON.stringify(err) })
      )
      return
    }

    if (text === '-1') {
      alert(intl.format(messages.itineraryCapacityError))
      return
    }
...
function fieldTripPlanIsInvalid (request, itineraries, intl) {
  ...
  if (
    ...
    alert(
      intl.format(
        messages.incompatibleTripDateError,
        {
...
function overwriteExistingRequestTripsConfirmed (request, outbound, intl) {
  ...
  if (preExistingTrip) {
    return confirm(
      intl.format(messages.confirmOverwriteItineraries, { outbound })
    )
  }
  return true
}
...
function makeFieldTripPlanRequests (request, outbound, intl) {
  return async function (dispatch, getState) {
    ...
    try {
      ...
      alert(
        intl.format(
          messages.fetchTripsForDateError, { err: JSON.stringify(err) }
        )
      )
      return
    }
    ...
    while (shouldContinueSearching) {
      ...
      if (numRequests > maxRequests) {
        ...
        alert(intl.format(messages.maxTripRequestsExceeded))
  ...
  return function (dispatch, getState) {
    ...
    return fetch(`${datastoreUrl}/fieldtrip/deleteTrip`,
      ...
      .catch(err => {
        alert(
          intl.format(
            messages.deleteItinerariesError,
            { err: JSON.stringify(err) }
          )
        )
      })
...
export function setRequestGroupSize (request, groupSize, intl) {
  return function (dispatch, getState) {
    ...
    return fetch(`${datastoreUrl}/fieldtrip/setRequestGroupSize`,
      ...
      .catch(err => {
        alert(
          intl.format(messages.setGroupSizeError, { err: JSON.stringify(err) })
        )
      })
  }
}
...
export function setRequestPaymentInfo (request, paymentInfo, intl) {
  return function (dispatch, getState) {
    ...
    return fetch(`${datastoreUrl}/fieldtrip/setRequestPaymentInfo`,
      ...
      .catch(err => {
        alert(
          intl.format(messages.setPaymentError, { err: JSON.stringify(err) })
        )
      })
  }
}
  ...
  return function (dispatch, getState) {
    ...
    return fetch(`${datastoreUrl}/fieldtrip/setRequestStatus`,
      ...
      .catch(err => {
        alert(
          intl.format(
            messages.setRequestStatusError,
            { err: JSON.stringify(err) }
          )
        )
      })
