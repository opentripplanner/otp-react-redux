...
/**
 * Sets the destination arrival time for the requested field trip.
 */
export function setArriveDestinationTime(request, time, intl) {
  return updateFieldTripRequest(
    request,
    FieldTripEndPoints.SET_DESTINATION_ARRIVAL_TIME,
    { time },
    intl,
    () =>
      intl.formatMessage({
 ...
 * Sets the destination arrival time for the requested field trip.
 */
export function setLeaveDestinationTime(request, time, intl) {
  return updateFieldTripRequest(
    request,
    FieldTripEndPoints.SET_DESTINATION_DEPART_TIME,
    { time },
    intl,
    () =>
      intl.formatMessage({
 ...
 * Sets the destination arrival time for the requested field trip.
 */
export function setArriveSchoolTime(request, time, intl) {
  return updateFieldTripRequest(
    request,
    FieldTripEndPoints.SET_SCHOOL_ARRIVAL_TIME,
    { time },
    intl,
    () =>
      intl.formatMessage({
